  ...
  return (
    <>
      ...
      <div className="container py-5 px-4">
        ...
        <ul className="ms-3">
          <li>
            <strong>Account Information:</strong> When you register or update
            your account, we collect information such as your name, email
            address, phone number, and password.
          </li>
          <li>
            <strong>Feedback and Reports:</strong> Any information you provide
            when submitting feedback, bug reports, or contacting customer
            support.
          </li>
        </ul>
        ...
        <ul className="ms-3">
          <li>
            ...
            with the App, including the features you use, the time spent on the
            App, and your preferences.
          </li>
          <li>
            <strong>Device Information:</strong> Details about the device you
            use to access the App, such as your device model, operating system,
        ...
        <p>
          ...
          for the purposes set out in this Privacy Policy. We will delete or
        ...
        <ul className="ms-3">
          <li>
            ...
            <Link href="mailto:info@legioconnect.com">
